...
export const en = {
  ...
  /* level hints */
  l2_hint: 'Fibers consume power without adding light — run the test without them.',
  l3_hint: 'Spread LEDs across all three zones and keep intensity high.',
  l4_hint: 'Stay on textile or soft-touch with 4–5 LEDs — carbon and fibers raise cost.',
  l5_hint: 'The master recipe: 6 LEDs at full intensity, no fibers, textile layer.',
  ...
  level1_hint:
    'Try placing the LED near the center of the area you want to light up.',
...
export const al: Record<TKey, string> = {
  ...
  /* level hints */
  l2_hint: 'Fibrat konsumojnë fuqi pa shtuar dritë — krye testin pa to.',
  l3_hint: 'Shpërndaji LED-at në të tria zonat dhe mbaj intensitetin lart.',
  l4_hint: 'Qëndro me tekstil ose soft-touch me 4–5 LED — karboni dhe fibrat e rrisin koston.',
  l5_hint: 'Receta e masterit: 6 LED në intensitet të plotë, pa fibra, shtresë tekstile.',
  ...
  level1_hint:
    'Provo ta vendosësh LED-in afër qendrës së zonës që dëshiron ta ndriçosh.',
